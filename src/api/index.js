...
export const TopPlaylist = () => {
    return axios.get('http://localhost:3000/user/playlist')
}
// 获取用户关注列表
export const UserFollows = () => {
    return axios.get('http://localhost:3000/user/follows')
}
// 获取用户粉丝列表
export const UserFolloweds = () => {
    return axios.get('http://localhost:3000/user/followeds')
}
// 获取用户等级
export const UserLevel = () => {
    return axios.get('http://localhost:3000/user/level')
}
// 新建歌单
export const PlaylistCreate = (name, privacy, type) => {
    return axios.get('http://localhost:3000/playlist/create', {
        params: {
            name,
            privacy,
            type
